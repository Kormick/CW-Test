...
/// Then iterate through each task in order and check its status.
/// If task if finished, collect the result and break the loop if it succeeded,
...
pub struct JoinHandleIter;

#[async_trait]
impl Solution for JoinHandleIter {
